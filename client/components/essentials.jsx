    ...
    <div className="container d-flex pt-5">
      <div className="w-50 pt-5 pb-5">
        ...
        <div className="d-flex align-items-center">
          ...
          <p className="list-text paragraphs-lists">6 training sessions over two weeks</p>
        </div>
        <div className="d-flex align-items-center">
          <i className="bi bi-check-circle-fill checkmark me-2"></i>
          <p className="list-text paragraphs-lists">Sessions are recorded to allow easy access anytime</p>
        </div>
        <div className="d-flex align-items-center">
          <i className="bi bi-check-circle-fill checkmark me-2"></i>
          <p className="list-text paragraphs-lists">Real world projects, coding exercises, skill assessments</p>
        </div>
        <div className="d-flex align-items-center">
          <i className="bi bi-check-circle-fill checkmark me-2"></i>
          <p className="list-text paragraphs-lists">25+ Lessons & Excercises</p>
        </div>
      </div>
